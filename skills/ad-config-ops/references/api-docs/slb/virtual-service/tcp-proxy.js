	...
	"paths": {
		"/api/ad/v3/slb/virtual-service/": {
							...
							"items": [
								{
									...
									"tcp_profile": "Default_TCP_L7",
									"sip_profile": "Default_SIP",
									"ipros": [],
									"qos_profile": "",
			...
			"post": {
				...
				"summary": "create new TCP virtual service",
				"description": "新建一个TCP虚拟服务配置",
		...
		"config.virtual_service": {
			...
			"properties": {
				...
				"vports": {
					...
					"type": "array",
					"items": {
						"description": "指定虚拟服务对外发布的端口信息, 支持单个端口 (如:8080) 和端口范围 (如:9090-9095)。",
						"type": "string"
					},
					"maxItems": 16,
					"minItems": 1,
