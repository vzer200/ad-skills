module.exports ={
	...
	"paths": {
		"/api/ad/v3/slb/virtual-service/": {
							...
							"items": [
								{
									...
									"pool": "tcp_forward_pool",
									"pre_rules": [
										"tcp_rule1"
									],
									"tcp_profile": "Default_TCP_L4",
									"ipros": [],
									"qos_profile": "",
			...
			"post": {
				...
				"summary": "create new TCP-FORWARD virtual service",
				"description": "新建一个TCP-FORWARD虚拟服务配置",
		...
		"/api/ad/v3/slb/virtual-service/{name}": {
			...
			"post": {
				...
				"summary": "create new TCP-FORWARD virtual service",
				"description": "新建指定的TCP-FORWARD虚拟服务配置",
	...
	"parameters": {
		...
		"VIRTUAL-SERVICE-PROPERTY": {
			...
			"in": "body",
			"required": true,
			"description": "TCP-FORWARD虚拟服务配置属性",
			"schema": {
				"$ref": "#/definitions/config.virtual_service"
			}
		}
