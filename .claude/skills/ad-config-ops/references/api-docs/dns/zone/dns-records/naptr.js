		...
		"/api/ad/v4/dns/zone/{dns_config_area}/dns-records/naptr/": {
			...
			"get": {
				...
				"x-examples": {
					"request": {
						...
						"value": {
							"method": "GET",
							"path": "/api/ad/v4/dns/zone/{dns_config_area}/dns-records/naptr/"
						}
					},
					"response": {
						"summary": "GET /api/ad/v4/dns/zone/{dns_config_area}/dns-records/naptr/ 响应",
						"description": "返回GET /api/ad/v4/dns/zone/{dns_config_area}/dns-records/naptr/的响应数据",
						"value": {
							"maximum_items": 4000,
							"total_pages": 5,
							"page_number": 5,
			...
			"post": {
				...
				"x-examples": {
					...
					"response": {
						"summary": "POST /api/ad/v4/dns/zone/{dns_config_area}/dns-records/naptr/ 响应",
						"description": "返回POST /api/ad/v4/dns/zone/{dns_config_area}/dns-records/naptr/的响应数据",
						"value": {
		...
		"/api/ad/v4/dns/zone/{dns_config_area}/dns-records/naptr/{name}": {
			...
			"get": {
				...
				"x-examples": {
					"request": {
						...
						"value": {
							"method": "GET",
							"path": "/api/ad/v4/dns/zone/{dns_config_area}/dns-records/naptr/{name}"
						}
					},
					"response": {
						"summary": "GET /api/ad/v4/dns/zone/{dns_config_area}/dns-records/naptr/{name} 响应",
						"description": "返回GET /api/ad/v4/dns/zone/{dns_config_area}/dns-records/naptr/{name}的响应数据",
						"value": {
							"name": "example_string",
							"description": "example_string",
							"state": "ENABLE",
			...
			"post": {
				...
				"x-examples": {
					...
					"response": {
						"summary": "POST /api/ad/v4/dns/zone/{dns_config_area}/dns-records/naptr/{name} 响应",
						"description": "返回POST /api/ad/v4/dns/zone/{dns_config_area}/dns-records/naptr/{name}的响应数据",
						"value": {
			...
			"put": {
				...
				"x-examples": {
					...
					"response": {
						"summary": "PUT /api/ad/v4/dns/zone/{dns_config_area}/dns-records/naptr/{name} 响应",
						"description": "返回PUT /api/ad/v4/dns/zone/{dns_config_area}/dns-records/naptr/{name}的响应数据",
						"value": {
							"name": "example_string",
							"description": "example_string",
							"state": "ENABLE",
			...
			"patch": {
				...
				"x-examples": {
					...
					"response": {
						"summary": "PATCH /api/ad/v4/dns/zone/{dns_config_area}/dns-records/naptr/{name} 响应",
						"description": "返回PATCH /api/ad/v4/dns/zone/{dns_config_area}/dns-records/naptr/{name}的响应数据",
						"value": {
							"name": "example_string",
							"description": "example_string",
							"state": "ENABLE",
			...
			"delete": {
				...
				"x-examples": {
					...
					"response": {
						"summary": "DELETE /api/ad/v4/dns/zone/{dns_config_area}/dns-records/naptr/{name} 响应",
						"description": "返回DELETE /api/ad/v4/dns/zone/{dns_config_area}/dns-records/naptr/{name}的响应数据",
						"value": {
							"name": "example_string",
							"description": "example_string",
							"state": "ENABLE",
