		...
		"/api/ad/v3/slb/pre-rule/any/": {
			...
			"get": {
				...
				"x-examples": {
					"request": {
						...
						"value": {
							"method": "GET",
							"path": "/api/ad/v3/slb/pre-rule/any/"
						}
					},
					"response": {
						"summary": "GET /api/ad/v3/slb/pre-rule/any/ 响应",
						"description": "返回GET /api/ad/v3/slb/pre-rule/any/的响应数据",
						"value": {
							"name": "url-sched",
			...
			"post": {
				...
				"x-examples": {
					...
					"response": {
						"summary": "POST /api/ad/v3/slb/pre-rule/any/ 响应",
						"description": "返回POST /api/ad/v3/slb/pre-rule/any/的响应数据",
						"value": {
							"name": "AI_url-sched_A",
							"description": "example_string",
							"service": "ANY",
		...
		"/api/ad/v3/slb/pre-rule/any/{name}": {
			...
			"get": {
				...
				"x-examples": {
					"request": {
						...
						"value": {
							"method": "GET",
							"path": "/api/ad/v3/slb/pre-rule/any/{name}"
						}
					},
					"response": {
						"summary": "GET /api/ad/v3/slb/pre-rule/any/{name} 响应",
						"description": "返回GET /api/ad/v3/slb/pre-rule/any/{name}的响应数据",
						"value": {
							"name": "url-sched",
							"description": "example_string",
							"service": "ANY",
			...
			"post": {
				...
				"x-examples": {
					...
					"response": {
						"summary": "POST /api/ad/v3/slb/pre-rule/any/{name} 响应",
						"description": "返回POST /api/ad/v3/slb/pre-rule/any/{name}的响应数据",
						"value": {
							"name": "AI_url-sched_B",
							"description": "example_string",
							"service": "ANY",
			...
			"put": {
				...
				"x-examples": {
					...
					"response": {
						"summary": "PUT /api/ad/v3/slb/pre-rule/any/{name} 响应",
						"description": "返回PUT /api/ad/v3/slb/pre-rule/any/{name}的响应数据",
						"value": {
							"name": "url-sched",
							"description": "example_string",
							"service": "ANY",
			...
			"patch": {
				...
				"x-examples": {
					...
					"response": {
						"summary": "PATCH /api/ad/v3/slb/pre-rule/any/{name} 响应",
						"description": "返回PATCH /api/ad/v3/slb/pre-rule/any/{name}的响应数据",
						"value": {
							"name": "url-sched",
							"description": "example_string",
							"service": "ANY",
			...
			"delete": {
				...
				"x-examples": {
					...
					"response": {
						"summary": "DELETE /api/ad/v3/slb/pre-rule/any/{name} 响应",
						"description": "返回DELETE /api/ad/v3/slb/pre-rule/any/{name}的响应数据",
						"value": {
							"name": "url-sched",
							"description": "example_string",
							"service": "ANY",
