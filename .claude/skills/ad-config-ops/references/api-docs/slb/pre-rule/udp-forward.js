		...
		"/api/ad/v3/slb/pre-rule/udp-forward/": {
			...
			"get": {
				...
				"x-examples": {
					"request": {
						...
						"value": {
							"method": "GET",
							"path": "/api/ad/v3/slb/pre-rule/udp-forward/"
						}
					},
					"response": {
						"summary": "GET /api/ad/v3/slb/pre-rule/udp-forward/ 响应",
						"description": "返回GET /api/ad/v3/slb/pre-rule/udp-forward/的响应数据",
						"value": {
							"name": "url-sched",
			...
			"post": {
				...
				"x-examples": {
					...
					"response": {
						"summary": "POST /api/ad/v3/slb/pre-rule/udp-forward/ 响应",
						"description": "返回POST /api/ad/v3/slb/pre-rule/udp-forward/的响应数据",
						"value": {
							"name": "AI_url-sched_A",
							"description": "example_string",
							"service": "UDP-FORWARD",
		...
		"/api/ad/v3/slb/pre-rule/udp-forward/{name}": {
			...
			"get": {
				...
				"x-examples": {
					"request": {
						...
						"value": {
							"method": "GET",
							"path": "/api/ad/v3/slb/pre-rule/udp-forward/{name}"
						}
					},
					"response": {
						"summary": "GET /api/ad/v3/slb/pre-rule/udp-forward/{name} 响应",
						"description": "返回GET /api/ad/v3/slb/pre-rule/udp-forward/{name}的响应数据",
						"value": {
							"name": "url-sched",
							"description": "example_string",
							"service": "UDP-FORWARD",
			...
			"post": {
				...
				"x-examples": {
					...
					"response": {
						"summary": "POST /api/ad/v3/slb/pre-rule/udp-forward/{name} 响应",
						"description": "返回POST /api/ad/v3/slb/pre-rule/udp-forward/{name}的响应数据",
						"value": {
							"name": "AI_url-sched_B",
							"description": "example_string",
							"service": "UDP-FORWARD",
			...
			"put": {
				...
				"x-examples": {
					...
					"response": {
						"summary": "PUT /api/ad/v3/slb/pre-rule/udp-forward/{name} 响应",
						"description": "返回PUT /api/ad/v3/slb/pre-rule/udp-forward/{name}的响应数据",
						"value": {
							"name": "url-sched",
							"description": "example_string",
							"service": "UDP-FORWARD",
			...
			"patch": {
				...
				"x-examples": {
					...
					"response": {
						"summary": "PATCH /api/ad/v3/slb/pre-rule/udp-forward/{name} 响应",
						"description": "返回PATCH /api/ad/v3/slb/pre-rule/udp-forward/{name}的响应数据",
						"value": {
							"name": "url-sched",
							"description": "example_string",
							"service": "UDP-FORWARD",
			...
			"delete": {
				...
				"x-examples": {
					...
					"response": {
						"summary": "DELETE /api/ad/v3/slb/pre-rule/udp-forward/{name} 响应",
						"description": "返回DELETE /api/ad/v3/slb/pre-rule/udp-forward/{name}的响应数据",
						"value": {
							"name": "url-sched",
							"description": "example_string",
							"service": "UDP-FORWARD",
