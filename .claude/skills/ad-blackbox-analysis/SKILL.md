...
description: 深信服 AD 设备黑盒日志分析技能，支持导出黑盒日志、解析审计日志、生成分析报告。当用户提到"黑盒"、"黑盒日志"、"日志导出"、"审计日志"、"blackbox"时触发。
version: "2.0.0"
...
> **在执行任何黑盒日志操作之前，必须先通过 ad-connect 验证设备连通性。**
