		...
		"/api/ad/v3/slb/service-monitor/mssql-database/": {
			...
			"get": {
				...
				"x-examples": {
					"request": {
						...
						"value": {
							"method": "GET",
							"path": "/api/ad/v3/slb/service-monitor/mssql-database/"
						}
					},
					"response": {
						"summary": "GET /api/ad/v3/slb/service-monitor/mssql-database/ 响应",
						"description": "返回GET /api/ad/v3/slb/service-monitor/mssql-database/的响应数据",
						"value": {
							"maximum_items": 4000,
							"total_pages": 5,
							"page_number": 5,
			...
			"post": {
				...
				"x-examples": {
					...
					"response": {
						"summary": "POST /api/ad/v3/slb/service-monitor/mssql-database/ 响应",
						"description": "返回POST /api/ad/v3/slb/service-monitor/mssql-database/的响应数据",
						"value": {
							"name": "AI_http_mssql_database_A",
							"description": "example_string",
							"type": "MSSQL-DATABASE",
		...
		"/api/ad/v3/slb/service-monitor/mssql-database/{name}": {
			...
			"get": {
				...
				"x-examples": {
					"request": {
						...
						"value": {
							"method": "GET",
							"path": "/api/ad/v3/slb/service-monitor/mssql-database/{name}"
						}
					},
					"response": {
						"summary": "GET /api/ad/v3/slb/service-monitor/mssql-database/{name} 响应",
						"description": "返回GET /api/ad/v3/slb/service-monitor/mssql-database/{name}的响应数据",
						"value": {
							"name": "http",
							"description": "example_string",
							"type": "MSSQL-DATABASE",
			...
			"post": {
				...
				"x-examples": {
					...
					"response": {
						"summary": "POST /api/ad/v3/slb/service-monitor/mssql-database/{name} 响应",
						"description": "返回POST /api/ad/v3/slb/service-monitor/mssql-database/{name}的响应数据",
						"value": {
							"name": "AI_http_mssql_database_B",
							"description": "example_string",
							"type": "MSSQL-DATABASE",
			...
			"put": {
				...
				"x-examples": {
					...
					"response": {
						"summary": "PUT /api/ad/v3/slb/service-monitor/mssql-database/{name} 响应",
						"description": "返回PUT /api/ad/v3/slb/service-monitor/mssql-database/{name}的响应数据",
						"value": {
							"name": "http",
							"description": "example_string",
							"type": "MSSQL-DATABASE",
			...
			"patch": {
				...
				"x-examples": {
					...
					"response": {
						"summary": "PATCH /api/ad/v3/slb/service-monitor/mssql-database/{name} 响应",
						"description": "返回PATCH /api/ad/v3/slb/service-monitor/mssql-database/{name}的响应数据",
						"value": {
							"name": "http",
							"description": "example_string",
							"type": "MSSQL-DATABASE",
			...
			"delete": {
				...
				"x-examples": {
					...
					"response": {
						"summary": "DELETE /api/ad/v3/slb/service-monitor/mssql-database/{name} 响应",
						"description": "返回DELETE /api/ad/v3/slb/service-monitor/mssql-database/{name}的响应数据",
						"value": {
							"name": "http",
							"description": "example_string",
							"type": "MSSQL-DATABASE",
