...
function helpText() {
  return [
    ...
    '',
    'Commands:',
    '  login    Store and verify public-base repository credentials',
    '  logout   Remove public-base credentials and local cache',
    ...
    '  public-base  Pack, publish, use, and validate public-base dependency bundles',
