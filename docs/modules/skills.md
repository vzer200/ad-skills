...
| `sangforad-cli` | `.claude/skills/sangforad-cli/` | Sangfor AD CLI command script generation from AD-OPS plans or filled bundles | `render_cli.py --bundle ... --ad-config-ops-root ...` |
...
ad-config-ops -> sangforad-cli for CLI output from validated bundles/plans
...
| Generate Sangfor AD CLI commands | `sangforad-cli` | hand-written command blocks or live CLI execution |
